...
public class UserApiController {
	...
	public ResponseEntity<?>profileImageUrlUpdate(@PathVariable int principalId, MultipartFile profileImageFile, @AuthenticationPrincipal PrincipalDetails principalDetails){
		...
		principalDetails.setUser(userEntity); //세션ㅂㅕㄴ경
	...
	public CMRespDto<?> update(
			...
			BindingResult bindingResult, // 꼭 @Valid가 적혀있는 다음 파라미터에 적어야 한다!
...
//				System.out.println("====================================");
			...
			return new CMRespDto<>(1, "회원수정완료", userEntity); // 응답 시 UserEntity의 모든 getter함수 호출 json으로 파싱하여 응다. 
		}
	}
}
